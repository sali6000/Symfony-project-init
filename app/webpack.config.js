...
Encore
    ...
    .addEntry('header_js', './assets/scripts/header.js')
    .addEntry('submenuRoll_js', './assets/scripts/submenuRoll.js')
    .addEntry('slider_js', './assets/scripts/slider.js')
    ...
    .addEntry('gallery_css','./assets/styles/galleryStylesheet.css')
     ...
     // Copy all images from assets/images to public/build/images
     .copyFiles({
        from: './assets/images',
